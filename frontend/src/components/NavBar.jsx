      ...
      <div className='menu flex gap-8 sm:w-full md:w-auto sm:flex-col md:flex-row'>
        ...
        {!isLoggedIn ? (
          ...
          <>
            ...
            <li className="menuList text-[#6f6f6f] border-2 border-black rounded-[20px] hover:text-white hover:bg-black hover:rounded-[17px] text-black p-2">Nhà tuyển dụng</li>
          </>
        ) : (
          // Sau đăng nhập
          <>
